...
if [ "$1" == '-h' ] || [ "$1" == '--help' ]; then
    ...
    echo "12. PACK rulegen will take the already cracked plaintext passwords and create a new rule, the rule is then used with the wordlist of your choise. Requires pyenchant (python3 -m pip install pyenchant==3.3.0) - Currently not working on Apple Silicon"
